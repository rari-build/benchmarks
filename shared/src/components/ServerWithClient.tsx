...
export default function ServerWithClient() {
  ...
  return (
    <div className="p-6 border border-blue-300 rounded-lg bg-blue-50">
      ...
      <div className="mb-6">
        <p className="text-blue-700 mb-2">This is a server component that contains:</p>
      ...
      <div className="border-t border-blue-200 pt-4">
        <h3 className="text-lg font-medium mb-3 text-blue-800">Client Component Below:</h3>
        <Counter />
      </div>
