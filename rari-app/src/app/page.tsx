      ...
      <div className="max-w-6xl mx-auto space-y-8">
        <div className="bg-white rounded-xl p-8 shadow-sm border border-gray-200 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 bg-blue-50 p-6 rounded-lg">
            <div className="text-center">
              <div className="text-2xl font-bold text-blue-600">Rust</div>
              <div className="text-sm text-blue-700">Runtime Engine</div>
            </div>
            <div className="text-center">
            ...
            <div className="text-center">
              ...
              <div className="text-sm text-green-700">Configuration</div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-linear-to-r from-green-50 to-blue-50 rounded-xl p-8 border border-green-200">
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            ...
            <div className="bg-white p-4 rounded-lg text-center">
              <div className="text-2xl font-bold text-green-600">Static</div>
          ...
          <div className="mt-6 text-center">
            <p className="text-gray-600">
              ...
              <br />
              <span className="text-sm text-gray-500">Powered by rari's Rust runtime</span>
            </p>
          </div>
        </div>
      </div>
